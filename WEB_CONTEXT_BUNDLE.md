...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-864-erd-s-problem-864-ad749622-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-864"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-864-erd-s-problem-864-ad749622-v1",
      "problem_contract_sha256": "30d4e86666b7bf9abeb409c85b07f352db6a8e1e247f688ae6dad9b2d0d29fef",
      "problem_id": "problem:um-ep-864-erd-s-problem-864-ad749622",
      "route_id": "route:um-ep-864-erd-s-problem-864-ad749622-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-864-erd-s-problem-864-ad749622-source-fidelity-01",
      "graph_id": "graph:um-ep-864-erd-s-problem-864-ad749622-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-864-erd-s-problem-864-ad749622-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-864-erd-s-problem-864-ad749622-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A\\subseteq \\{1,\\ldots N\\}$ be a set such that there exists at most one $n$ with more than one solution to $n=a+b$ (with $a\\leq b\\in A$). Estimate the maximal possible size of $\\lvert A\\rvert$ - in particular, is it true that $ \\lvert A\\rvert \\leq (1+o(1))\\frac{2}{\\sqrt{3}}N^{1/2}? $"
          },
          "statement_sha256": "b95f01b39a8631b821f60d42dee542aac25ce79e130f0decf69886976ec967ed"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-864-erd-s-problem-864-ad749622-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-864-erd-s-problem-864-ad749622-root",
      "route_id": "route:um-ep-864-erd-s-problem-864-ad749622-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-864-fba7ae866a99",
        "url": "https://www.unsolvedmath.com/problems/EP-864"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
